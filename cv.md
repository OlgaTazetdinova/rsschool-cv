...
* Manual Testing
* Defect / Bug Tracking
* Regression, Functional, Smoke, Sanity Testing
...
* Databases: SQL
* Protocols & Formats: HTTP, XML, JSON, SIP
...
**Primatest** — *March 2022 – Present*

* Worked on personnel management software: candidate and employee profiles, timesheets, workflow (web UI + mobile apps)
* Performed requirements analysis
* Created test plans, cases, and checklists; executed manual tests
* Participated in planning and estimation for change requests
* Full defect life-cycle management
* Manual testing: functional, usability, UI, cross-browser
* API testing using Postman and Charles Proxy
...
* Developed test plans, data, cases, and reports
* Executed hardware/manual/API testing; tested firmware upgrades and recovery
* Participated in QA review meetings and shared documentation
* Engaged in daily standups, backlog grooming, sprint planning, retrospectives
...
**Schnellecke** — *January 2014 – May 2015*

* Managed quality systems in production
